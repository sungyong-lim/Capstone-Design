...
public class GalleryActivity extends BasicActivity {
    ...
    @Override
    public void onRequestPermissionsResult(int requestCode, @NonNull String permissions[], @NonNull int[] grantResults) {   //권한 받는 부분
        switch (requestCode) {
            case 1: {
...
//        if(media == GALLERY_VIDEO){   비디오도 파일 불러오는 부분
